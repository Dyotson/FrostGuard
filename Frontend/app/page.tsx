            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Link href="/aboutus" className="w-full">
                <Card className="flex flex-col items-center text-center p-6">
                  ...
                  <CardContent>
                    <CardDescription className="text-gray-600 dark:text-gray-300">
                      Utiliza modelos avanzados para predecir y prevenir daños
                      por heladas y otros eventos climáticos.
                    </CardDescription>
                  </CardContent>
                </Card>
              </Link>
              ...
              <Link href="/aboutus" className="w-full">
                <Card className="flex flex-col items-center text-center p-6">
                  ...
                  <CardContent>
                    <CardDescription className="text-gray-600 dark:text-gray-300">
                      Implementa estrategias de protección personalizadas
                      basadas en datos específicos de tu ubicación.
                    </CardDescription>
                  </CardContent>
                </Card>
              </Link>
